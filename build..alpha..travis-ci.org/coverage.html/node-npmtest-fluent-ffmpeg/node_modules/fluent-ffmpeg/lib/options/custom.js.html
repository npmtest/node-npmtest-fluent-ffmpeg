...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-fluent-ffmpeg/node_modules/fluent-ffmpeg/lib/options/custom.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-fluent-ffmpeg/node_modules/fluent-ffmpeg/lib/options/custom.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-fluent-ffmpeg/node_modules/fluent-ffmpeg/lib/options/</a> &#187; custom.js</div>
</div>
<div class="body">
...
module.exports = function(proto) {
  ...
  proto.inputOption =
  proto.inputOptions = <span class="fstat-no" title="function not covered" >function(options) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var doSplit = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (arguments.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      options = [].slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >      doSplit = false;</span>
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._currentInput.options(options.reduce(<span class="fstat-no" title="function not covered" >function(options, option) {</span></span>
<span class="cstat-no" title="statement not covered" >      var split = String(option).split(' ');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (doSplit &amp;&amp; split.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >        options.push(split[0], split[1]);</span>
      } else {
...
&nbsp;
  ...
  proto.withOptions =
  proto.outputOption =
  proto.outputOptions = <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >    var doSplit = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (arguments.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      options = [].slice.call(arguments);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._currentOutput.options(options.reduce(<span class="fstat-no" title="function not covered" >function(options, option) {</span></span>
<span class="cstat-no" title="statement not covered" >      var split = String(option).split(' ');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (doSplit &amp;&amp; split.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >        options.push(split[0], split[1]);</span>
...
&nbsp;
   ...
   */
  proto.filterGraph =
  proto.complexFilter = <span class="fstat-no" title="function not covered" >function(spec, map) {</span>
<span class="cstat-no" title="statement not covered" >    this._complexFilters.clear();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(spec)) {</span>
<span class="cstat-no" title="statement not covered" >      spec = [spec];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._complexFilters('-filter_complex', utils.makeFilterStrings(spec).join(';'));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(map)) {</span>
<span class="cstat-no" title="statement not covered" >      var self = this;</span>
<span class="cstat-no" title="statement not covered" >      map.forEach(<span class="fstat-no" title="function not covered" >function(streamSpec) {</span></span>
<span class="cstat-no" title="statement not covered" >        self._complexFilters('-map', streamSpec.replace(utils.streamRegexp, '[$1]'));</span>
      });
    } else <span class="cstat-no" title="statement not covered" >if (typeof map === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      this._complexFilters('-map', map.replace(utils.streamRegexp, '[$1]'));</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
